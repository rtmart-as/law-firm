...
public class GeneratorMySQL {
     ...
     * 数据库连接url
     */
    public static final String URL = "jdbc:mysql://localhost/lvsuo?serverTimezone=GMT%2B8&characterEncoding=utf8&useUnicode=true&useSSL=false";
    /**
     * 数据库 用户名
     */
     ...
     * 作者
     */
    public static final String AUTHOR = "shengyuee";
    /**
     * java代码保存目录
     */
...
//    public static final String SAVE_PATH = "code-generator";
     ...
     * xml保存目录
     */
    public static final String XML_SAVE_PATH = System.getProperty("user.dir") + "/src/main/resources/mapper";
//    public static final String XML_SAVE_PATH ="code-generator";
    /**
     * 保存到包下面
     */
    public static final String PACKAGE = "com.ychs.web.sys_user";
    /**
     * 要生成的表
     */
